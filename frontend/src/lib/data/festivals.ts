...
const mockFestivals: Festival[] = [
  {
    ...
    summary: 'A solemn Islamic observance commemorating the martyrdom of Hussein and Hassan at the Battle of Karbala.',
...
**Food**: Street vendors sell doubles and other local food nearby`,
  ...
  },
  {
    ...
    summary: 'The annual celebration of the Santa Rosa First Peoples Community - the last organized Indigenous group in Trinidad & Tobago.',
...
**What to bring**: Cash for crafts and food, water, sunscreen`,
  ...
  },
  {
    ...
    heritageType: 'indigenous',
    festivalType: 'cultural',
    summary: 'A week-long celebration of Indigenous heritage, featuring ceremonies, exhibitions, and educational events.',
...
**Best for**: Families, students, anyone interested in T&T history`,
  ...
  },
  {
    ...
    heritageType: 'indian',
    festivalType: 'religious',
    summary: 'The Hindu Festival of Lights, celebrated as a national holiday with the largest observance in the English-speaking Caribbean.',
...
**Cost**: Entrance to Nagar is free; budget for food and crafts`,
  ...
  },
  {
    ...
    heritageType: 'indian',
    festivalType: 'religious',
    summary: 'The vibrant Hindu spring festival of colors, celebrating the victory of good over evil and the arrival of spring.',
...
**Warning**: Colors are semi-permanent - oil your hair and skin beforehand`,
  ...
  },
  {
    ...
    summary: 'National holiday commemorating the abolition of slavery in the British Empire in 1834.',
...
**Dress code**: African attire encouraged but not required`,
  ...
  },
  {
    ...
    heritageType: 'african',
    festivalType: 'religious',
    summary: 'Commemorating the 1951 repeal of the Shouter Prohibition Ordinance that had banned the Spiritual Baptist faith for 34 years.',
...
**What to wear**: Modest, respectful attire; women may want to bring a head covering`,
  ...
  },
  {
    ...
    heritageType: 'indian',
    festivalType: 'religious',
    summary: 'Open-air theatrical performances of the Hindu epic Ramayana, held at over 35 sites across Trinidad.',
...
**Best night**: Final night for Ravana's burning (Dussehra)`,
  ...
  },
  {
    ...
    heritageType: 'mixed',
    festivalType: 'cultural',
    summary: 'The traditional Christmas music of Trinidad, blending Spanish, African, and Indigenous influences into joyous celebration.',
...
**Food pairings**: Pastelles, black cake, sorrel, ponche de crème`,
  ...
  },
  {
    ...
    heritageType: 'mixed',
    festivalType: 'cultural',
    summary: 'The Greatest Show on Earth - Trinidad\'s world-famous celebration of music, mas, and freedom.',
