...
const mockMemories: Memory[] = [
  ...
  // First Peoples Heritage Week
  {
    ...
    authorEmail: null,
    content: `I had no idea about Amerindian heritage in Trinidad until I attended a Heritage Week event in Arima. The smoke ceremony was powerful — I could feel the connection to something much older than colonial history. Every Trini should learn about this part of who we are.`,
    yearOfMemory: '2023',
    status: 'approved',
